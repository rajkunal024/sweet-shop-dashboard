        ...
        <div className="container py-16 md:py-24 relative">
          <div className="max-w-2xl mx-auto text-center page-transition">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Discover our collection of artisan chocolates, candies, and
              confections made with the finest ingredients.
            </p>
            {!user && (
        ...
        {user ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Create an account or sign in to browse and purchase our delicious
              sweets.
            </p>
